        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-6 md:mb-0">
              <h2 className="text-xl font-bold mb-4">ShoeStore</h2>
              <p className="text-gray-400 max-w-md">Quality footwear for every occasion. From casual to formal, sports to hiking, we've got you covered.</p>
            </div>
          ...
          <div className="mt-8 border-t border-gray-800 pt-8 flex items-center justify-between">
            <p className="text-gray-400 text-sm">© 2025 ShoeStore. All rights reserved.</p>
